const description = {
  ...
  link_account_id_exists:
    'حساب با {{type}} {{value}} از قبل وجود دارد. آیا می‌خواهید پیوند دهید؟',
  ...
  password_expiration_reminder:
    'رمز عبور شما در {{days}} روز منقضی می‌شود. توصیه می‌کنیم همین الان آن را بازنشانی کنید.',
  password_expiration_reminder_skip: 'فعلاً رد کن',
