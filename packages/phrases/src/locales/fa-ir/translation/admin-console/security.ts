const security = {
  ...
  password_policy: {
    ...
    breached_passwords_description: 'رمزهای عبوری که قبلاً در پایگاه‌های داده نشت یافتند را رد کنید.',
    ...
    enable_password_expiration_description:
      'از کاربران بخواهید به‌صورت دوره‌ای رمز عبور را بازنشانی کنند. کاربران موجود بدون تاریخ ثبت‌شده تغییر رمز عبور بر اساس تاریخ ایجاد حساب ارزیابی می‌شوند.',
    ...
    expiration_period_error: 'دوره اعتبار رمز عبور باید حداقل ۱ روز باشد.',
    expiration_reminder: 'یادآوری انقضا (روز قبل از انقضا)',
    expiration_reminder_description:
      'تعداد روز قبل از انقضا برای هشدار به کاربران و درخواست بازنشانی رمز عبور. کاربران می‌توانند یادآوری را رد کنند و به ورود ادامه دهند.',
    expiration_reminder_error:
      'دوره یادآوری انقضا باید بین ۰ و دوره اعتبار ({{max}} روز) باشد.',
  },
  sentinel_policy: {
    ...
    manual_unlock: {
      title: 'باز کردن دستی',
      description:
        'کاربران را فوراً با تأیید هویت و وارد کردن شناسه آن‌ها باز کنید.',
  ...
  blocklist: {
    ...
    custom_email_address: {
      ...
      placeholder:
        'آدرس یا دامنه ایمیل مسدود را وارد کنید (مثلاً bar@example.com، @example.com)',
      duplicate_error: 'آدرس یا دامنه ایمیل از قبل اضافه شده است',
      invalid_format_error:
        'باید آدرس ایمیل معتبر (bar@example.com) یا دامنه (@example.com) باشد',
    },
  },
};
