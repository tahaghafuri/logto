const applications = {
  ...
  type: {
    ...
    spa: {
      ...
      subtitle: 'برنامه‌ای که در مرورگر وب اجرا می‌شود و داده‌ها را به‌صورت پویا به‌روزرسانی می‌کند',
  ...
  authorization_flow: {
    title: 'جریان مجوزدهی',
    tooltip:
      'جریان مجوزدهی برنامه خود را انتخاب کنید. پس از تنظیم، این قابل تغییر نیست.',
    authorization_code: {
      title: 'کد مجوز',
      description:
