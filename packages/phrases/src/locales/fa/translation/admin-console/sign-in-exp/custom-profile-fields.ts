const custom_profile_fields = {
  table: {
    ...
    placeholder: {
      ...
      description: 'فیلدها را برای جمع‌آوری اطلاعات بیشتر پروفایل کاربر در هنگام ثبت‌نام سفارشی کنید.',
    },
  },
  type: {
    Text: 'متن',
  ...
  modal: {
    ...
    custom_data_field_input_placeholder: 'کلید داده کاربر را وارد کنید، مثلاً `myFavoriteFieldName`',
    custom_field: {
      title: 'داده سفارشی',
      description:
