...
const application_details = {
  ...
  access_control: {
    ...
    rules_description: 'کاربران می‌توانند به این برنامه دسترسی داشته باشند اگر با هر یک از قوانین پیکربندی‌شده مطابقت داشته باشند.',
    ...
    rule_user_roles_description: 'کاربرانی که به نقش‌های کاربری انتخاب‌شده تخصیص داده شده‌اند می‌توانند به این برنامه دسترسی داشته باشند.',
  ...
  branding: {
    ...
    description_third_party:
      'نام نمایشی و لوگوی برنامه خود را در صفحه رضایت سفارشی کنید.',
    ...
    more_info_description: 'جزئیات بیشتری درباره برنامه خود را در صفحه رضایت به کاربران ارائه دهید.',
  ...
  secrets: {
    ...
    delete_confirmation:
      'این عمل قابل بازگشت نیست. آیا مطمئنید که می‌خواهید این رمز را حذف کنید؟',
  ...
  saml_idp_config: {
    ...
    description:
      'از متادیتا و گواهینامه زیر برای پیکربندی IdP SAML در برنامه خود استفاده کنید.',
  ...
  saml_app_attribute_mapping: {
    ...
    description: 'نگاشت‌های ویژگی را برای همگام‌سازی پروفایل کاربر از Logto به برنامه خود اضافه کنید.',
