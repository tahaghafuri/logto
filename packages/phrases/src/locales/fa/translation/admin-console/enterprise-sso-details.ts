const enterprise_sso_details = {
  ...
  readme_drawer_subtitle: 'اتصال‌دهنده‌های SSO سازمانی را برای فعال‌سازی SSO کاربران نهایی تنظیم کنید',
  ...
  connector_logo_field_description: 'هر تصویر باید کمتر از ۵۰۰ کیلوبایت باشد، فقط SVG، PNG، JPG، JPEG.',
  ...
  upload_saml_idp_metadata_info_text_manual:
    'متادیتا از ارائه‌دهنده هویت را برای اتصال پر کنید.',
  ...
  idp_initiated_auth_config: {
    ...
    default_application_tooltip:
      'برنامه هدفی که کاربر پس از احراز هویت به آن هدایت می‌شود.',
