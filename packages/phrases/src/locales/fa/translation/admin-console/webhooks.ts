const webhooks = {
  ...
  title: 'وب‌هوک‌ها',
  subtitle: 'وب‌هوک ایجاد کنید تا به‌راحتی به‌روزرسانی‌های لحظه‌ای درباره رویدادهای خاص دریافت کنید.',
  create: 'ایجاد وب‌هوک',
  schemas: {
  ...
  create_form: {
    ...
    events: 'رویدادها',
    events_description: 'رویدادهای ماشه‌ای را انتخاب کنید که Logto درخواست POST را برای آن‌ها ارسال می‌کند.',
    name: 'نام',
