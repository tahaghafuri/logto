const connector = {
  ...
  invalid_certificate:
    'گواهی اتصال‌دهنده نامعتبر است، لطفاً مطمئن شوید گواهی در قالب PEM است.',
  ...
  invalid_type_for_syncing_profile: 'فقط می‌توانید پروفایل کاربر را با اتصال‌دهنده‌های اجتماعی همگام کنید.',
