const session = {
  ...
  passkey_sign_in: {
    ...
    conflict_rp_id: 'شناسه Relying Party مطابقت ندارد. لطفاً از کلاینت صحیح برای ورود استفاده کنید.',
    sso_users_not_allowed: 'گزینه ورود با passkey برای کاربران SSO واجد شرایط نیست.',
  },
  password_expiration: {
    reset_not_allowed:
      'بازنشانی رمز عبور فقط پس از انقضای رمز عبور در نشست ورود فعلی مجاز است.',
  },
  ...
  email_blocklist: {
    ...
    email_not_allowed:
      'آدرس ایمیل «{{email}}» محدود شده است. لطفاً آدرس دیگری انتخاب کنید.',
  },
  google_one_tap: {
